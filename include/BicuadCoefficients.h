...
#pragma region Constructors
	...
	explicit BicuadCoefficients(double a0_Value
															, double a1_Value
															, double a2_Value
															, double b0_Value
															, double b1_Value
...
#pragma region Filter Coefficients Calc
	...
	static BicuadCoefficients BandPass(double Fc, double Q,
																		 double Fs);

	// calculate coefficients for a HighPass filter.
	static BicuadCoefficients HighPass(double Fc,
																		 double Q, double Fs);

	// calculate coefficients for a LowPass filter.
	static BicuadCoefficients LowPass(double Fc, double Q,
																		double Fs);

	// calculate coefficients for a AllPass filter with Q factor.
	static BicuadCoefficients AllPassQ(double Fc, double Q,
																		 double Fs);

	// calculate coefficients for a HighPass filter with Q factor.
	static BicuadCoefficients HighShelfQ(double peakGain, double Fc,
																			 double Q, double Fs);

	// calculate coefficients for a LowShelf filter with Q factor.
	static BicuadCoefficients LowShelfQ(double peakGain, double Fc,
																			double Q, double Fs);

	// calculate coefficients for a Notch filter with Q factor.
	static BicuadCoefficients Notch(double Fc, double Q,
																	double Fs);

	// calculate coefficients for a Peaking EQ filter with Q factor.
	static BicuadCoefficients PeakEq(double peakGain, double Fc,
																	 double Q, double Fs);

	// calculate coefficients for a HighPass filter.
	static BicuadCoefficients HighShelf(double peakGain,
																			double Fc, double Fs);

	// calculate coefficients for a LowShelf filter.
	static BicuadCoefficients LowShelf(double peakGain,
																		 double Fc, double Fs);

	// calculate coefficients for a OnePoleLowPass filter.
	static BicuadCoefficients OnePoleLowPass(double Fc,
																					 double Fs);

	// calculate coefficients for a OnePoleHighPass filter.
	static BicuadCoefficients OnePoleHighPass(double Fc,
																						double Fs);

	// calculate coefficients for a 1stOrder AllPass filter.
	static BicuadCoefficients AllPass1stOrder(double Fc,
																						double Fs);
	// calculate coefficients for a 1stOrder LowPass filter.
	static BicuadCoefficients LowPass1stOrder( double Fc, double Fs);

	// calculate coefficients for a 1stOrder HighPass1stOrder filter.
	static BicuadCoefficients HighPass1stOrder(double Fc,
																						 double Fs);

	// calculate coefficients for a 1stOrder LowShelffilter.
	static BicuadCoefficients LowShelf1stOrder(double peakGain,
																						 double Fc, double Fs);

	// calculate coefficients for a 1stOrder HighShelf filter.
	static BicuadCoefficients HighShelf1stOrder(double peakGain,
																							double Fc, double Fs);
#pragma endregion
